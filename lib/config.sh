...
mst_config_apply_defaults() {
    ...
    export MST_SECURITY_EVENTS_AUTH_LOG_PATH="/var/log/auth.log"
...
mst_config_validate() {
    ...
    mst_validate_absolute_path "${MST_SECURITY_EVENTS_AUTH_LOG_PATH:-}" || mst_die "${MST_EXIT_USAGE}" "MST_SECURITY_EVENTS_AUTH_LOG_PATH must be absolute"
    ...
    mst_validate_non_negative_integer "${MST_SECURITY_EVENTS_SSH_FAILED_WARN_COUNT:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid SSH failed login warning threshold"
    mst_validate_non_negative_integer "${MST_SECURITY_EVENTS_SSH_ROOT_ATTEMPT_WARN_COUNT:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid SSH root attempt warning threshold"
    mst_validate_boolean_flag "${MST_SECURITY_EVENTS_FAIL2BAN_ENABLED:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid Fail2Ban enabled flag"
    mst_validate_security_events_fail2ban_jails "${MST_SECURITY_EVENTS_FAIL2BAN_JAILS:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid Fail2Ban jail list"
    mst_validate_non_negative_integer "${MST_SECURITY_EVENTS_FAIL2BAN_NEW_BLOCK_WARN_COUNT:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid Fail2Ban new block warning threshold"
    mst_validate_boolean_flag "${MST_SECURITY_EVENTS_SUDO_CHECK_ENABLED:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid sudo check enabled flag"
    mst_validate_boolean_flag "${MST_SECURITY_EVENTS_CRON_CHECK_ENABLED:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid cron check enabled flag"
    mst_validate_non_negative_integer "${MST_SECURITY_EVENTS_PACKAGE_UPDATES_WARN_COUNT:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid package update warning threshold"
    ...
    mst_validate_positive_integer "${MST_ALERT_MIN_OCCURRENCES_BEFORE_DELIVERY:-}" || mst_die "${MST_EXIT_USAGE}" "Invalid alert confirmation threshold"
